<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexAtom.aspx.cs" Inherits="OxiteSite.Views.Home.IndexAtom" %><%@ Import Namespace="System.Xml" %><%
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <link rel="alternate" type="text/html" hreflang="<%=Config.Site.LanguageDefault %>" href="<%=GetAbsolutePath(Url.RouteUrl("Home")).ToLower() %>"/>

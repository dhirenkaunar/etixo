...
namespace Oxite.Data
{
    ...
    {
        public static string GetUrl(this ITag tag, RequestContext context, RouteCollection routes)
        {
            return routes.GetUrl(context, "TagPermalink", new {tagName = tag.Parent.Name});
        }

        public static int GetTagWeight(this ITag tag, IEnumerable<KeyValuePair<ITag, int>> tagsWithPostCount,
                                       ref double? averagePostCount, ref double? standardDeviationOfPostCount)
        {
